...
import BoardComponent from './SidebarContent/boardComponent.jsx';
import TemplateComponent from './SidebarContent/templateComponent.jsx';
// import Login from '../LoginPage/loginPage.tsx';
import CreateBoardModal from './SidebarContent/Board/CreateBoardModal.jsx';
...
const HomePage = () => {
    ...
    //     if (workspaceName) {
    //         // const newWorkspace = { name: workspaceName, boards: [] };
    //         const newWorkspace = { name: workspaceName, boards: [] }; 
    ...
    // Call API to create a new workspace
                            ...
                            <h2 className="flex text-sm font-semibold mb-2">
                                ...
                                <div>
                                {
                                    ...
                                    <div key={index} className="flex items-start justify-between mb-2">
                                        ...
                                        <button onClick={() => deleteWorkspace(index)} className="focus:outline-none">
                                            <DeleteIcon/>
                                        </button>
                                    </div>
                                ))}
